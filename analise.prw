...
Função ANALISE
@type function
@param none, variant, Não recebe parâmetros
@return variant, Não retorna nada
...
@history
04/10/2012, reinaldo, - Acrescimo de cabecalho Protheus.Doc
05/10/2012, reinaldo, - Inclusao do botao de parametros e validacao para utilizacao somente em ambiente TOP.
/*/
//----------------------------------------------------------
...
@ 001,375 BUTTON "Processar"       SIZE 30,10 ACTION (Processa({||fNumSeq(),fDetaSDA(0)}))             PIXEL OF oFolder:aDialogs[12]
...
Função MarcaTodos
@type function
@param lMark, logical, Recebo o lMark
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vide/analise()
...
Função fDetaSB8
@type function
@param nPosAT, numeric, recebe a posicao da varialvel AT no acols
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vida/analise()
...
Função fMontaSB8
@type function
@param lFiltro, logical, Filtra os dados por lote
@param nPosAT, numeric, recebe a posicao da varialvel AT no acols
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
...
Função fAjustSB2
@type function
@param cOpcao, character, utilizado para identificar o tipo de alteracao
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vide/analise()
...
Função fAjustSB8
@type function
@param cOpcao, character, utilizado para identificar uma alteracao ou exclusao
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vide/analise()
...
@type function
@param cOpcao, character, utilizado para identificar uma alteracao ou exclusao
@param cFolder, character, utilizado para identificar o folder
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vide/analise()
...
@type function
@param cOpcao, character, utilizado para identificar o tipo de alteracao
@param cLoteCtl, character, numero do lote
@param cDoc, character, numero do documento
@param dData, date, data da movimentacao
@param nQuant, numeric, quantidade
@param cEndereco, character, endereco
@param cNumSeq, character, numero sequencial
@param cTipoMov, character, tipo de movimento
@param cNumLote, character, numero do numlote
@param cSerie, character, numero da serie
@param cCliFor0, character, codigo do cliente/fornecedor
...
Função fMovto
@type function
@param lSB8, logical, identifica se o movimento e' na tabela SB8
@param lSD5, logical, identifica se o movimento e' na tabela SD5
@param cProduto, character, codigo do produto
@param cLocal, character, codigo do almoxarifado
@param cLoteCtl, character, numero do lote
@param cNumLote, character,  numero do numlote
@param cLoteFor, character, numero do lote do fornecedor
@param cCliFor, character, codigo do cliente/fornecedor
@param cLoja, character, codigo da loja 
@param cTm, character, tipo de movimento
@param cOrigLan, character, origem do lancamento
@param cChave, character, chave de controle
@param cNumSeq, character, numero sequencial
@param cDoc, character, numero documento
@param cSerie, character, numero da serie
@param cOp, character, numero da ordem de producao
@param nQuant, numeric,  quantidade do movimento
@param nQuant2UM, numeric, quantidade do movimento na segunda unidade de medida
@param dData, date, data do movimento
@param dDtValid, date, data de validade
@param lCrialote, logical, identifica se deve criar o numero do lote
@param nPotencia, numeric, numero da potencia
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vide/analise()
...
@param cNumLote, character, numero do numlote
@param cNumSeq, character, numero sequencial
@param cEndereco, character, numero do endereco
@param nQuant, numeric, quantidade do movimento
@param nQuant2UM, numeric, quantidade do movimento na segunda unidade de medida
@return variant, Não retorna nada
@author Reinaldo Dias
...
@type function
@param cOpcao, character, utilizado para identificar uma alteracao ou exclusao
@param oBrowse, object, utilizado para passar objetivo oBrowse
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vide/analise()
...
Função fPesq
@type function
@param cOpcao, character, utilizado para identificar qual tabela sera pesquisada
@param cCampos, character, numero do campo
@param cSeek, character, chave de pesquisa
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vide/analise()
...
Função fPesqDifLote
@type function
@param cOpcao, character, utilizado para identificar a pesquisa no proximo/anterior
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vide/analise()
...
Função fPesqNumSeq
@type function
@param cOpcao, character, utilizado para identificar a pesquisa por lote ou endereco
@return variant, Não retorna nada
@author Reinaldo Dias
@owner Totvs S/A
@since vide/analise()
...
Return
/*/{Protheus.doc} IMESTDIF
Execucao da rotina pelo smartclient
@type function
@version 1
@author luiz.favareto@accesssistemas.com.br
@since 22/10/2024
/*/
User Function IMESTDIF
    MsApp():New("SIGAEST")
    oApp:CreateEnv()
    oApp:cStartProg := "U_ANALISE"
    __lInternet := Nil
    oApp:Activate()
Return
/*
