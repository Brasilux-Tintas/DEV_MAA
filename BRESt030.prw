...
DEFINE MSDIALOG oDlg TITLE "Calculos IBGE" FROM 000, 000 TO 400, 250 COLORS 0, 16777215 PIXEL

    @ 010, 010 SAY OemToAnsi("Data de..? ") SIZE 050,009 PIXEL OF oDlg FONT oFontBtn
    @ 008, 060 MSGET oInicio VAR cInicio PICTURE "@9" SIZE 050,010 COLOR CLR_BLUE PIXEL ON CHANGE oDlg FONT oFontBtn
   ...
   /* @ 050, 010 SAY OemToAnsi("IBGE.: ") SIZE 020,009 PIXEL  OF oDlg FONT oFontBtn
    ...
    @ 090,020 BUTTON oBtnFech PROMPT "Gerar Planilha" SIZE 080, 018 OF oDlg ACTION MsAguarde({|| Imprimir() },"Calculando..","Aguarde...") FONT oFontBtn PIXEL
