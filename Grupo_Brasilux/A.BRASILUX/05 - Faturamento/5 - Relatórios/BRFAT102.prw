...
/////////////////////////////////////////////////////////
//                                                     //
// Funçào....: BRFAT102     Data....: 08/12/2020       //
// Autor.....: Cleber Orati Domingues                  //
// Descriçao.: Rel. de Pedidos Aprovados por Represen  //
...
tamanho  :="M"
limite   :=132
titulo   :="PEDIDOS APROVADOS POR REPRESENTANTE"
cDesc1   :=PADC("Este programa ira emitir o Rel. de Ped Aprovados por Representante",74)
cDesc2   :=""
cDesc3   :=PADC(" ",74)
cCabec   :=PADC("Rel. Ped. Apr. por Repres.",27)
cCabPro  :=""
cNatureza:=""
...
if __cUserId = "000282"
	cQuery += "AND (F2_VEND1 NOT IN ('000250','000444','000303','000333','000438','000276')) "
endif 
if !empty(MV_PAR05)
...
"LEFT OUTER JOIN "+RetSqlName("SD2")+" SD2 WITH (NOLOCK) ON (SD2.D_E_L_E_T_ <> '*') AND (D2_FILIAL = D1_FILIAL) AND (D2_SERIE =  D1_SERIORI) AND (D2_DOC = D1_NFORI) AND (D2_ITEM = D1_NFORI) AND (D2_CLIENTE = D1_FORNECE) AND (D2_LOJA = D1_LOJA) "+;
...
u_xPutSX1(cPerg,"02","Data Emissao Ate ?" ,"Data Emissao Ate ?"  ,"Data Emissao Ate ?"  ,"mv_ch2" ,"D",08,0,0,"G",""  ,""    ,""  ,""  , "mv_par02","","","","","","","","","","","","","","","","",Nil,Nil,Nil,"BRFAT102")
u_xPutSx1(cPerg,"03","Repres. De  ?      ", "Repres. De  ?    "  , "Repres. De  ?      ","mv_ch3" ,"C", 6,0,0,"G", " ", "SA3", " ", " ", "mv_par03","","","","","","","","","","","","","","","","",Nil,Nil,Nil,"BRFAT102")
u_xPutSx1(cPerg,"04","Repres Ate ?"       , "Repres Ate ?"       , "Repres Ate ?"       ,"mv_ch4" ,"C", 6,0,0,"G", " ", "SA3", " ", " ", "mv_par04","","","","","","","","","","","","","","","","",Nil,Nil,Nil,"BRFAT102")
aadd(aHelp, {{"Informe a Linha de Produto"},  {"Informe a Linha de Produto"}, {"Informe a Linha de Produto"}})
u_xPutSx1(cPerg,"05","Linha(s) Produto"    ,"Linha(s) Produto"    ,"Linha(s) Produto"    ,"mv_ch5","C" ,99,0,0,"G",""  ,""    ,""  ,""  ,"mv_par05" ,"","","","","","","","","","","","","","","","",aHelp[1,1],aHelp[1,2],aHelp[1,3],"BRFAT102")
...
u_xPutSx1(cPerg,"06","Região Geográf?"     ,"Região Geográf?"     ,"Região Geográf?"     ,"mv_ch6","C",  2,0,0,"G",""  ,"ZE"  ,""  ,""  ,"mv_par06" ,"","","","","","","","","","","","",aHelp[2,1],aHelp[2,2],aHelp[2,3],"")
u_xPutSx1(cPerg,"10","Do Cliente         " , "Do Cliente         ", "Do Cliente         ","mv_cha","C", 6,0,0 ,"G", " ", "SA1", " ", " ", "mv_par11","","","","","","","","","","","","","","","","",Nil       ,Nil       ,Nil       ,"BRFAT102")
u_xPutSx1(cPerg,"11","Até o Cliente      ", "Até o Cliente      ", "Até o Cliente      ", "mv_chb","C", 6,0,0,"G", " ", "SA1", " ", " ", "mv_par12","","","","","","","","","","","","","","","","",Nil,Nil,Nil,"BRFAT102")
