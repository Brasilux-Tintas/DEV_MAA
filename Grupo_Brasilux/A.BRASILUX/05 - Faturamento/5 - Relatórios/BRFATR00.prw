...
//ValidPerg(cPerg)
	...
	/*Adicionado por Lucas - 18-09-2025. Chamado R8434*/
	If FWISINCALLSTACK("U_BRFATA01")
		cCodigo := SZA->ZA_CODIGO
		MV_PAR01 := cCodigo

		wnrel:=SetPrint(cString,wnrel,,Titulo,cDesc1,cDesc2,cDesc3,.F.,,.F.,'G')
