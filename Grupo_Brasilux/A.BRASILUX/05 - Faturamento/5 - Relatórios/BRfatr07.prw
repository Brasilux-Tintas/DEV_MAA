...
AAdd(aHelp, {{"Informe a Linha de Produto"},  {"Informe a Linha de Produto"}, {"Informe a Linha de Produto"}})
       ...
       U_xPutSX1(cPerg, "11",   "Imprime por        ", "Imprime por        ", "Imprime por        ", "mv_chc", "N",  1, 0, 1, "C", " ",   " ", " ", " ", "mv_par11", "Produto"         , "Produto", "Produto"     , " "   , "Linha"           , "Linha"     , "Linha"     , "Cliente x Prod." , "Cliente x Prod."     , "Cliente x Prod."     , "Repres. x Prod." , "Repres. x Prod."     , "Repres. x Prod."     , "Anali/Sint(p15)",  "Anali/Sint(p15)",  "Anali/Sint(p15)"     , Nil  , Nil     , Nil     , cPerg)
