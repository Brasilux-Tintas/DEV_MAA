...
User Function BRFATX68()
	 ...
	 oCBox1     := TCheckBox():New( 266,287,"Pallet Padrão",{|u| If(PCount() > 0, lCheck := u, lCheck)},oGrp2Env,080,012,,,oFontEnv,,CLR_BLUE ,CLR_WHITE,,.t.,"Bloqueia Bipe Qdo Ultrapassa Limite",, )	
...
Static Function fValCodPro(nOpcMnt)  //1 - Montagem do Pallet 2- Desmontagem
    ...
    Local _nXVALIDA := GetMv("MV_XVALIDA") //LGS#20200210 - Adequação de release 12.1.25 e posteriores
    Local _nXVALESP := GetMv("MV_XVALESP") //LGS#20200210 - Adequação de release 12.1.25 e posteriores
    //Local _n
