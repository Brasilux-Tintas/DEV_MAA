...
Static Function fCriaPrw()
	...
	Else
		...
		Else
		   ...
		   ( _cAliasSX3 )->( DbSetOrder(2) ) //X3_CAMPO
           //Percorre a estrutura
           For nAtual := 1 To Len(aStrutAux)
               //Se conseguir posicionar no campo
