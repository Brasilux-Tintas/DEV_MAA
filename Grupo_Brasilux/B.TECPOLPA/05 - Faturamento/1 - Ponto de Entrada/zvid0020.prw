...
Local aRet := {}          
aAdd(aRet,{'Gera SA de KITS','U_FMONTATELA()', 0 , 2})
Return aRet

User Function M105BUT()
Local aRet := {}          
aAdd(aRet,{'Criação de Kits', {||U_fMontaTela()}, "Kits","* Kits"} )
Return aRet

User Function fMontaTela()
    Local nLargBtn      := 50
    Local nLinhaObj     := 0
    Local nLargPanel    := 0
    ...
    //Cria a janela
    DEFINE MSDIALOG oDlgExemp TITLE "Montagem de Kits"  FROM 0, 0 TO nJanAltu, nJanLarg PIXEL
